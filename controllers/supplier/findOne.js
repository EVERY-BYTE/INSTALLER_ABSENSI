...
exports.findOneSupplier = void 0;
...
const findOneSupplier = async (req, res) => {
    const { error, value } = (0, validateRequest_1.validateRequest)(supplierSchema_1.findOneSupplierSchema, req.params);
    if (error != null) {
    ...
    try {
        ...
        logger_1.default.info('Supplier found successfully');
...
exports.findOneSupplier = findOneSupplier;
