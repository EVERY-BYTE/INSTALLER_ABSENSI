...
exports.findOneSpg = exports.findAllSpg = void 0;
...
const findAllSpg = async (req, res) => {
...
exports.findAllSpg = findAllSpg;
const findOneSpg = async (req, res) => {
