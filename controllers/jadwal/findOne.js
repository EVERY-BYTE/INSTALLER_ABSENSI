...
const findOneJadwal = async (req, res) => {
    const { error, value } = (0, validateRequest_1.validateRequest)(jadwalSchema_1.findOneJadwalSchema, req.params);
    if (error != null) {
    ...
    try {
        ...
        logger_1.default.info('Jadwal found successfully');
...
exports.findOneJadwal = findOneJadwal;
