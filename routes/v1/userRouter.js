...
router.patch('/', middlewares_1.middleware.useAuthorization, async (req, res) => await auth_1.UsersController.update(req, res));
router.patch('/spg', middlewares_1.middleware.useAuthorization, async (req, res) => await auth_1.UsersController.updateSpg(req, res));
router.delete('/', middlewares_1.middleware.useAuthorization, async (req, res) => await auth_1.UsersController.remove(req, res));
